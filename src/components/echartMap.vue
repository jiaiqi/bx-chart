<template>
  <div
    id="chartMapView"
    :style="{ width: cwidth + 'px', height: cheight - 30 + 'px' }"
  ></div>
</template>

<script>
import panjin from '../assets/common/panjin.json'
...
export default {
  ...
  methods: {
    setEchartMapData (e, d) {
      // this.$echarts.registerMap('panjin', panjin)
      // this.$echarts.registerMap('yanan', yanan)
      let self = this;
      // let mapName = "panjin";
      let mapName = "yanan";
      let max = 13000,
      ...
      // let mapFeatures = yanan.features
      // let mapFeatures = panjin.features
  ...
  created () {
    this.$on("timelineChange", function (e) {
